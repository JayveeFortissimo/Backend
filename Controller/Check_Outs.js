...
function CheckOut(req, res) {
    ...
    const sql = `INSERT INTO check_out(picture, product_Name, size, start_Date, return_Date, price, quantity, subTotal, user_ID, payment_Method, status, PD, item_id, code) VALUES ?`;
